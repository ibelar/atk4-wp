 ...
 */
jQuery.widget("ui.atk4_richtext", {
   	options: {
   	},
	_create: function(){
      	this.elementHTML = jQuery('<div/>').addClass('ui-widget ui-widget-content');
		this.element.wrap(jQuery('<div/>').addClass('atk4_richtext_html')).after(this.elementHTML).addClass('atk4_richtext').hide();
