...
/**
 *  Basic Form use in Wp Widgets or Metabox
 *
 * Modifiying the addField function in order to adapt to Wordpress widget and metabox.
 * Field form need to have seperate name and id value, as opposed to atk where
 * field name and id are the same.
 *
 * Widget field also required wordpress css class and addField will take care of this.
 *
 */
class Wp_Custom_Form extends Form_Basic
{
